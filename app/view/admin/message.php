        ...
        <div class="home-content">
            <div class="messages">
              <div class="message">
                ...
                ?>
                <h2 class="nom"><?= htmlspecialchars($message['subject']) ?> </h2>
                <span><?= htmlspecialchars($message['name']) ?></span>
                <span><?= htmlspecialchars($message['email']) ?></span>
                <p><?= htmlspecialchars($message['message']) ?></p>
                <span>Envoyé depuis le <?= date('d/m/Y', strtotime($message['sent_at'])) ?> </span>
                <a href="#">repondre</a>
                <a href="message.php?delete=<?= $message['id'] ?>" onclick="return confirm('Supprimer ce message ?');" class="btn">supprimer</a>
                <hr>
                <?php
                    }
                }
