  ...
  <footer class="footer">
    <div class="footer-content">
      ...
      <div class="footer-links">
        <a href="/butterfly_photography/public/index.php">Accueil</a>
        <a href="#about">À propos</a>
        <a href="/butterfly_photography/public/gallery.php">Galerie</a>
        <a href="#contact">Contact</a>
        <a href="/butterfly_photography/public/dashboard.php">se connecter</a>
      </div>
